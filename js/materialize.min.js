...
Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity, Materialize.Vel = Vel || Velocity,
    ...
    function(t) {
        ...
        t.fn.tabs = function(i) { return e[i] ? e[i].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof i && i ? void t.error("Method " + i + " does not exist on jQuery.tabs") : e.init.apply(this, arguments) }, t(document).ready(function() { t("div.tabs").tabs() })
    }(jQuery),
    function(t) {
